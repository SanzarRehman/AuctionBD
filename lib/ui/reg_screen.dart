...
import 'package:auctionbd/ui/user_form.dart';
  ...
  signUp() async {
    try {
      ...
      if (authCredential.uid.isNotEmpty) {
        Navigator.push(
            context, CupertinoPageRoute(builder: (_) => Uploadpic()));
      } else {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Welcome Buddy!",
                          style: TextStyle(
                              fontSize: 22.sp, color: AppColours.deep_purple),
                        ),
                        Text(
                        ...
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                              primary: AppColours.deep_purple,
                              elevation: 3,
                            ),
                          ),
                        ),
